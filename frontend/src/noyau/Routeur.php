...
class Routeur
{
    ...
    public function executer(): void
    {
        ...
        echo '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8">'
            ...
            . '<h1 class="display-3 fw-bold text-success mb-2">404</h1>'
            . '<p class="fs-5 text-muted mb-4">Cette page n\'existe pas ou n\'est plus disponible.</p>'
            . '<a href="' . htmlspecialchars(url('/')) . '" class="btn btn-success px-4">Retour à l\'accueil</a>'
            . '</div></body></html>';
    }
}