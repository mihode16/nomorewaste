...
<head>
    ...
    <title><?php echo htmlspecialchars($titre ?? 'Espace commerçant'); ?> — NO MORE WASTE</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center fw-bold notranslate" href="<?php echo url('/commercant/dashboard'); ?>">
        ...
        <div class="collapse navbar-collapse" id="navEspace">
            <ul class="navbar-nav espace-nav me-auto ms-3">
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'dashboard' ? 'active' : ''; ?>" href="<?php echo url('/commercant/dashboard'); ?>">
                        <i class="bi bi-speedometer2"></i> Tableau de bord
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'collectes' ? 'active' : ''; ?>" href="<?php echo url('/commercant/collectes'); ?>">
                        <i class="bi bi-truck"></i> Mes collectes
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'adhesion' ? 'active' : ''; ?>" href="<?php echo url('/commercant/adhesion'); ?>">
                        <i class="bi bi-card-checklist"></i> Mon adhésion
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'contact' ? 'active' : ''; ?>" href="<?php echo url('/commercant/messages'); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'profil' ? 'active' : ''; ?>" href="<?php echo url('/commercant/profil'); ?>">
