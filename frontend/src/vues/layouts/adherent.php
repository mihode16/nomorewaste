...
<head>
    ...
    <title><?php echo htmlspecialchars($titre ?? 'Espace adhérent'); ?> — NO MORE WASTE</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navEspace">
            <ul class="navbar-nav espace-nav me-auto ms-3">
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'dashboard' ? 'active' : ''; ?>" href="<?php echo url('/adherent/dashboard'); ?>">
                        <i class="bi bi-speedometer2"></i> Tableau de bord
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'services' ? 'active' : ''; ?>" href="<?php echo url('/adherent/services'); ?>">
                        <i class="bi bi-calendar-event"></i> Services
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'adhesion' ? 'active' : ''; ?>" href="<?php echo url('/adherent/adhesion'); ?>">
                        <i class="bi bi-card-checklist"></i> Mon adhésion
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'messages' ? 'active' : ''; ?>" href="<?php echo url('/adherent/messages'); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $pageActive === 'profil' ? 'active' : ''; ?>" href="<?php echo url('/adherent/profil'); ?>">
