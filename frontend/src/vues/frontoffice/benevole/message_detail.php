...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <a href="<?php echo url('/benevole/messages'); ?>" class="text-decoration-none small"><i class="bi bi-arrow-left"></i> Retour à mes messages</a>
...
<?php if (empty($c['cloturee'])): ?>
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form method="POST" action="<?php echo url('/benevole/messages/' . (int)$c['id'] . '/repondre'); ?>">
                <div class="mb-2">
...
<?php else: ?>
    <div class="alert alert-light border small">
        ...
        <a href="<?php echo url('/benevole/messages/creer'); ?>">nouveau message</a>.
    </div>
<?php endif; ?>
