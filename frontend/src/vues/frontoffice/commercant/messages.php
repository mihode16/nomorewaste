...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo url('/commercant/messages/creer'); ?>" class="btn btn-success">
...
<?php else: ?>
    <?php foreach ($conversations as $c): ?>
        <a href="<?php echo url('/commercant/messages/' . (int)$c['id']); ?>" class="text-decoration-none text-reset">
